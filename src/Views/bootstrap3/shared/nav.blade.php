<div class="panel panel-default">
    <div class="panel-body">
        <ul class="nav nav-pills">
            <li role="presentation" class="{!! $tools->fullUrlIs(route(getNamedRouteFromSetting('main_route', '', 'index'))) ? "active" : "" !!}">
                <a href="{{ route(getNamedRouteFromSetting('main_route', '', 'index')) }}">{{ trans('ticketit::lang.nav-active-tickets') }}
                    <span class="badge">
                         <?php 
                            if ($u->isAdmin()) {
            ...
            <li role="presentation" class="{!! $tools->fullUrlIs(route(getNamedRouteFromSetting('main_route', 'complete', 'index'))) ? "active" : "" !!}">
                <a href="{{ route(getNamedRouteFromSetting('main_route', 'complete', 'index')) }}">{{ trans('ticketit::lang.nav-completed-tickets') }}
                    <span class="badge">
                        <?php 
                            if ($u->isAdmin()) {
