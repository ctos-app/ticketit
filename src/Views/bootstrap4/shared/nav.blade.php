<nav>
    <ul class="nav nav-pills">
        <li role="presentation" class="nav-item">
            <a class="nav-link {!! $tools->fullUrlIs(route(getNamedRouteFromSetting('main_route', '', 'index'))) ? "active" : "" !!}"
                href="{{ route(getNamedRouteFromSetting('main_route', '', 'index')) }}">{{ trans('ticketit::lang.nav-active-tickets') }}
        ...
        <li role="presentation" class="nav-item">
            <a class="nav-link {!! $tools->fullUrlIs(route(getNamedRouteFromSetting('main_route', 'complete', 'index'))) ? "active" : "" !!}"
                 href="{{ route(getNamedRouteFromSetting('main_route', 'complete', 'index')) }}">{{ trans('ticketit::lang.nav-completed-tickets') }}
                <span class="badge badge-pill badge-secondary">
                    <?php 
                        if ($u->isAdmin()) {
